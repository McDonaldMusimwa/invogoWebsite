...
Since this application is not yet live ,make sure your installed expo mobile on your IOS or Android device.
Once you have expo installed 

To start to the app run the command 

    npm run start

Follow the instruction given by expo to scan the QR code.
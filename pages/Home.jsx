    ...
    <div  id="home" style={{marginTop:'100px'}}>
      <div className={styles.HomeContainer}>
        <div>
          ...
          <p>
            Invogo is a disruptive mobile application developed for streamlining
            the ease of doing buiness for tradesman.Wether you are a
            plumber,electrician or what ever business you run we make invoiving
            and accouting very easy for you.{" "}
          </p>
